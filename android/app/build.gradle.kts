...
//    }
    ...
    productFlavors {
        create("therealapp8") {
            ...
            applicationId = "com.example.TheRealApp8"
            resValue("string", "app_name", "TheRealApp8")
        }
        create("therealapp7") {
            dimension = "environment"
            applicationId = "com.example.TheRealApp7"
            resValue("string", "app_name", "TheRealApp7")
        }
        create("therealapp4") {
            dimension = "environment"
            applicationId = "com.example.TheRealApp4"
            resValue("string", "app_name", "TheRealApp4")
        }
        create("therealapp3") {
            dimension = "environment"
            applicationId = "com.example.TheRealApp3"
            resValue("string", "app_name", "TheRealApp3")
        }
        create("real1") {
            dimension = "environment"
            applicationId = "com.example.real1"
            resValue("string", "app_name", "Real1")
        }
